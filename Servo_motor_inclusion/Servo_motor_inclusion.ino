//suggestions : Motor Task change to function.
...
volatile int task_suspend_check_flag = 0; // Make volatile for FreeRTOS interaction
// --- Sensor Definitions ---
...
void motor_actuation() {
  ...
  Serial.println("Tasks stopped for motor actuation.");
...
//       vTaskSuspend(uploadTaskHandle);
//       Serial.println("Upload Task Suspended");
//     }
//     if (readFieldTaskHandle != NULL) {
//       vTaskSuspend(readFieldTaskHandle);
//       Serial.println("Read Field Task Suspended");
//     }
//     task_suspend_check_flag = 1;
//   } 
//   else {
//     Serial.println("Tasks Already Suspended");
//   }
// }
...
void setup() {
  ...
  if (wifiReadySemaphore == NULL) {
    ...
    Serial.println("wifiReadySemaphore created.");
  }
  ...
  if (targetTimeQueue == NULL) {
    ...
    Serial.println("targetTimeQueue created.");
  }
  ...
  if (sensorDataQueue == NULL) {
    ...
    Serial.println("sensorDataQueue created.");
  }
  ...
  if (sensorMutex == NULL) {
    ...
    Serial.println("sensorMutex created.");
  }
  ...
  if (uploadMutex == NULL) {
    ...
    Serial.println("uploadMutex created.");
  }
